...
@dataclass
class PrismaticInternVLCausalLMOutputWithPast(ModelOutput):
...
class PrismaticInternVLForConditionalGeneration(InternVLForConditionalGeneration):
    def __init__(self, config: OpenVLAInternVLConfig) -> None:
        ...
        # Extract vision backbone and projector from InternVL model
        self.vision_backbone = self.model.vision_tower
        ...
        self.vision_backbone.set_num_images_in_input = lambda x: setattr(
    ...
    def forward(
        ...
        use_film: bool = False,
    ) -> Union[Tuple, PrismaticInternVLCausalLMOutputWithPast]:
        """Run a forward pass through the VLM, returning a PrismaticInternVLCausalLMOutputWithPast instance."""
        ...
        # === Otherwise =>> Assume Invalid! ===
            ...
            raise ValueError(
                "Invalid PrismaticInternVLForConditionalGeneration `forward()` call with provided arguments:\n"
        ...
        # Unpack `language_model_output` and return PrismaticInternVLCausalLMOutputWithPast (or tuple if not `return_dict`)
        if not return_dict:
        ...
        return PrismaticInternVLCausalLMOutputWithPast(
...
class OpenVLAInternVLForActionPrediction(PrismaticInternVLForConditionalGeneration):
    config_class: Type[PretrainedConfig] = OpenVLAInternVLConfig
